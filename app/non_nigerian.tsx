...
//     // Navigation: Routing to bvn_validation but with the flag to skip BVN boxes
//     router.push({
//       pathname: '/bvn_validation' as any,
//       params: { 
//         isNonNigerian: 'true',
...
//           >
//             <View style={styles.headerSection}>
//                 <Text style={styles.titleText}>Global Access</Text>
//                 <Text style={styles.subtitleText}>Provide your official details as a non-resident client.</Text>
//             </View>
...
//                   onValueChange={(value) => setSelectedCountry(value)}
//                   items={countries}
//                   placeholder={{ label: 'Select your country...', value: null, color: '#94A3B8' }}
//                   style={pickerSelectStyles}
//                 />
//               </View>
//             </View>
...
//   titleText: { fontSize: 28, fontWeight: '800', color: '#0F172A' },
//   subtitleText: { fontSize: 15, color: '#64748B', marginTop: 8, textAlign: 'center' },
//   card: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 24, elevation: 2 },
//   inputLabel: { fontSize: 11, fontWeight: '700', color: '#94A3B8', letterSpacing: 1, marginBottom: 8 },
//   asterisk: { color: '#EF4444' },
//   input: { borderBottomWidth: 1.5, borderBottomColor: '#F1F5F9', paddingVertical: 10, marginBottom: 24, fontSize: 16, color: '#0F172A', fontWeight: '600' },
//   pickerWrapper: { borderBottomWidth: 1.5, borderBottomColor: '#F1F5F9', paddingVertical: 5 },
//   signupButton: { backgroundColor: '#003366', height: 58, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginTop: 35 },
//   buttonText: { color: 'white', fontSize: 16, fontWeight: '700' },
//   backButton: { marginTop: 25, alignSelf: 'center' },
//   backButtonText: { color: '#64748B', fontSize: 15, fontWeight: '600', textDecorationLine: 'underline' },
// });

// const pickerSelectStyles = StyleSheet.create({
//   inputIOS: { fontSize: 16, paddingVertical: 10, color: '#0F172A', fontWeight: '600' },
//   inputAndroid: { fontSize: 16, color: '#0F172A', fontWeight: '600', paddingVertical: 8 },
